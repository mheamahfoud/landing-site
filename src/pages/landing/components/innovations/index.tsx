...
const Innovations = () => {
  ...
  return (
    <Container
      ...
      style={{ gap: "50px" }}
    >
      <SectionTitle title={intl.formatMessage({id:'our_innovations'})} sectionNumber="05" />
      ...
      >
        <ContainerCard className="d-flex justify-content-between">
          <InnerContainerCard className="flex-fill-item d-flex flex-column  align-items-center flex-wrap">
            <InnovationCard title={intl.formatMessage({id:'voice_library'})} url={voiceLibrarySrc} />
            <VoiceLibrary />
          </InnerContainerCard>

          <InnerContainerCard className="flex-fill-item align-items-center d-flex flex-column">
            <InnovationCard title={intl.formatMessage({id:'tazmeen_system'})}  url={TazmeenSystemSrc} />
            <TazmeenSystem />
          </InnerContainerCard>
